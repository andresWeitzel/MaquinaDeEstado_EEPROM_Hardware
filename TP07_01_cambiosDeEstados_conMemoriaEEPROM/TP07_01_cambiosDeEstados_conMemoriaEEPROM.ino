...
flag4=0;
        ...
        if (salidaMenu1 == 4) {        // si salidaMenu1 llega a 7  deja de parpadear y selecciona el potenciomentro (menu0) o contador con pulsadores (menu1)
          ...
          if (flagMenu == 2) {               // en estos if selecciono a q case voy a ir con respecto al case q estuve anteriormente.
            menu = 3;
          }
          if (flagMenu == 1) {               // en estos if selecciono a q case voy a ir con respecto al case q estuve anteriormente.
            menu = 2;
          }
          if (flagMenu == 0) {
            menu = 0;
